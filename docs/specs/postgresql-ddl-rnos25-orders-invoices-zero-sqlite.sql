-- RNOS-25 — Order / Invoice schema (Zero SQLite safe)
-- Same as 2026-07-27-postgresql-ddl-rnos25-orders-invoices.sql except lead_id has no FK:
-- VPS crm_leads uses sqlite_lead_id as the legacy bridge, not BIGINT id PK.
